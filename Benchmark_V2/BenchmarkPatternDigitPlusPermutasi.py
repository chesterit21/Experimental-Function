...
def process_game_data(df, game_code):
    ...
    formatted_output_filepath = os.path.join(OUTPUT_DIR, f"{game_code}_{latest_periode}_data_hasil_temuan_v2.txt")
    ...
    pure_output_filepath = os.path.join(OUTPUT_DIR, f"{game_code}_{latest_periode}_pure_data_temuan_v2.txt")
